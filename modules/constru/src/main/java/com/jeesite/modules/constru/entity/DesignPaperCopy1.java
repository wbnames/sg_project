...
@Table(name="design_paper_copy1", alias="a", label="施工任务信息", columns={
		...
		@Column(name="constru_id", attrName="construId", label="constru_id", isInsert=false, isUpdate=false, isQuery=false),
...
public class DesignPaperCopy1 extends DataEntity<DesignPaperCopy1> {
	...
	private ConstruTask productionCode;		// 编号 父类
	...
	public DesignPaperCopy1(ConstruTask productionCode){
	...
	public ConstruTask getProductionCode() {
		return productionCode;
	}

	public void setProductionCode(ConstruTask productionCode) {
		this.productionCode = productionCode;
	}
