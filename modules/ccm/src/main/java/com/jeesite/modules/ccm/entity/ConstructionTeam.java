 ...
 * @version 2022-05-30
 */
@Table(name="construction_team", alias="a", label="施工班组信息", columns={
...
public class ConstructionTeam extends DataEntity<ConstructionTeam> {
	...
	public ConstructionTeam(String id){
		super(id);
	}
