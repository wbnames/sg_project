...
@Table(name="design_product", alias="a", label="设计图纸信息", columns={
		...
		@Column(name="contractl_code", attrName="contractlCode.numCode", label="合同编号"),
...
public class DesignProduct extends DataEntity<DesignProduct> {
	
	private static final long serialVersionUID = 1L;
	private String numCode;		// 编号
	private DesignPaper contractlCode;		// 合同编号 父类
	...
	public DesignProduct(DesignPaper contractlCode){
	...
	public DesignPaper getContractlCode() {
		return contractlCode;
	}

	public void setContractlCode(DesignPaper contractlCode) {
		this.contractlCode = contractlCode;
	}
