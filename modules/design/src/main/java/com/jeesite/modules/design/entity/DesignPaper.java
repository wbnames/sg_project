...
public class DesignPaper extends DataEntity<DesignPaper> {
	...
	private List<DesignProduct> designProductList = ListUtils.newArrayList();		// 子表列表
	...
	public List<DesignProduct> getDesignProductList() {
		return designProductList;
	}

	public void setDesignProductList(List<DesignProduct> designProductList) {
		this.designProductList = designProductList;
	}
