...
public class DesignPPP extends DataEntity<DesignPPP> {
	...
	private ProductionManager productId;		// 产品编号 父类
	...
	public DesignPPP(ProductionManager productId){
	...
	public ProductionManager getProductId() {
		return productId;
	}

	public void setProductId(ProductionManager productId) {
		this.productId = productId;
	}
